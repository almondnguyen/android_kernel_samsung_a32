...
#define SENSOR_TYPE_GEOMAGNETIC_POWER               (SENSOR_TYPE_DEVICE_PRIVATE_BASE + 3) // 30
...
#define SENSOR_TYPE_PROXIMITY_CALIBRATION           (SENSOR_TYPE_DEVICE_PRIVATE_BASE + 13) // 40
#define SENSOR_TYPE_PROTOS_MOTION                   (SENSOR_TYPE_DEVICE_PRIVATE_BASE + 14)
#define SENSOR_TYPE_FLIP_COVER_DETECTOR             (SENSOR_TYPE_DEVICE_PRIVATE_BASE + 15)
#define SENSOR_TYPE_LEGACY_MAX                      (SENSOR_TYPE_DEVICE_PRIVATE_BASE + 16)
...
#define SENSOR_NAME_ACCELEROMETER                    (1)
#define SENSOR_NAME_GEOMAGNETIC_FIELD                (2)
#define SENSOR_NAME_GYROSCOPE                        (4)
#define SENSOR_NAME_LIGHT                            (5)
#define SENSOR_NAME_PRESSURE                         (6)
#define SENSOR_NAME_PROXIMITY                        (8)
#define SENSOR_NAME_MAGNETIC_FIELD_UNCALIBRATED     (14)
#define SENSOR_NAME_GYROSCOPE_UNCALIBRATED          (16)
#define SENSOR_NAME_SIGNIFICANT_MOTION              (17)
#define SENSOR_NAME_STEP_DETECTOR                   (18)
#define SENSOR_NAME_STEP_COUNTER                    (19)
#define SENSOR_NAME_TILT_DETECTOR                   (22)
#define SENSOR_NAME_WAKE_GESTURE                    (23)
#define SENSOR_NAME_PICK_UP_GESTURE                 (25)
#define SENSOR_NAME_ACCELEROMETER_INT               (SENSOR_TYPE_DEVICE_PRIVATE_BASE + 1)
#define SENSOR_NAME_PROXIMITY_RAW                   (SENSOR_TYPE_DEVICE_PRIVATE_BASE + 2)
#define SENSOR_NAME_GEOMAGNETIC_POWER               (SENSOR_TYPE_DEVICE_PRIVATE_BASE + 3)
#define SENSOR_NAME_INTERRUPT_GYRO                  (SENSOR_TYPE_DEVICE_PRIVATE_BASE + 4)
#define SENSOR_NAME_SCONTEXT                        (SENSOR_TYPE_DEVICE_PRIVATE_BASE + 5)
#define SENSOR_NAME_MOBEAM                          (SENSOR_TYPE_DEVICE_PRIVATE_BASE + 6)
#define SENSOR_NAME_LIGHT_CCT                       (SENSOR_TYPE_DEVICE_PRIVATE_BASE + 7)
#define SENSOR_NAME_CALL_GESTURE                    (SENSOR_TYPE_DEVICE_PRIVATE_BASE + 8)
#define SENSOR_NAME_WAKE_UP_MOTION                  (SENSOR_TYPE_DEVICE_PRIVATE_BASE + 9)
#define SENSOR_NAME_LIGHT_AUTOBRIGHTNESS            (SENSOR_TYPE_DEVICE_PRIVATE_BASE + 10)
#define SENSOR_NAME_VDIS_GYROSCOPE                  (SENSOR_TYPE_DEVICE_PRIVATE_BASE + 11)
#define SENSOR_NAME_POCKET_MODE                     (SENSOR_TYPE_DEVICE_PRIVATE_BASE + 12)
#define SENSOR_NAME_PROXIMITY_CALIBRATION           (SENSOR_TYPE_DEVICE_PRIVATE_BASE + 13)
